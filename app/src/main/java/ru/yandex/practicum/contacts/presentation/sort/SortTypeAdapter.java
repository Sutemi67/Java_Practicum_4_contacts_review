...
public class SortTypeAdapter extends RecyclerView.Adapter<SortTypeAdapter.ViewHolder> {
    ...
    private final AsyncListDiffer<SortTypeUI> differ = new AsyncListDiffer<>(new AdapterListUpdateCallback(this), new AsyncDifferConfig.Builder<>(new BaseListDiffCallback<SortTypeUI>()).build());
